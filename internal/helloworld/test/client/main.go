...
func main() {
	...
	defer conn.Close()
	client := helloworld.NewHelloWorldServiceNATSClient(conn, protonats.WithChainUnaryInterceptor(shared.TimingInterceptor("first"), shared.OTelClientInterceptor, shared.TimingInterceptor("second")))
